...
# ============================================================================================#
taxiTripsDF = taxiTripsDF.withColumn(
    "TripStartDT", taxiTripsDF["pickup_datetime"].cast("date")
)
taxiTripsDF = taxiTripsDF.withColumn(
    "TripEndDT", taxiTripsDF["dropoff_datetime"].cast("date")
)
...
# ============================================================================================#
taxiTripsDF = (
    taxiTripsDF.withColumn("trip_distance", taxiTripsDF["trip_distance"].cast("double"))
...
taxiTripsDF = (
    taxiTripsDF.withColumn("hourd", hour(taxiTripsDF["pickup_datetime"]))
...
taxiTripsDF = taxiTripsDF.drop(
    ...
    "passenger_count > 0 and passenger_count < 8  AND tip_amount >= 0 AND tip_amount < 30 AND fare_amount >= 1 AND fare_amount < 150 AND trip_distance > 0 AND trip_distance < 100 "
)
...
hdfs_query = (
    taxiTripsDF.writeStream.format("parquet")
